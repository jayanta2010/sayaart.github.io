...
let confirmationResult = null; // Store Phone OTP Session
...
// Phone OTP Authentication Engine
...
if (sendOtpBtn) {
  sendOtpBtn.onclick = async () => {
    ...
    if (!phoneNumber) return alert("Please enter mobile number!");
...
if (verifyOtpBtn) {
  verifyOtpBtn.onclick = async () => {
    ...
    try {
      ...
      verifyOtpBtn.style.background = "#059669";
  ...
  async function loadAdminProducts() {
    ...
    try {
      ...
      snap.forEach(docSnap => {
        ...
        adminProductList.innerHTML += `
          <div class="product-list-item" style="display:flex; justify-content:space-between; align-items:center; border: 1px solid #cbd5e1; padding: 12px; margin-bottom: 10px; border-radius: 6px; background:#fff;">
            <div>
